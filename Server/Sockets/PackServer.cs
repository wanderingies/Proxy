...
namespace Proxy.Sockets
{
    ...
    public class PackServer
    {
        ...
        public PackServer(int numConnections, int receiveBufferSize, int overtime, uint headerFlag)
        {
            ...
            Thread thread = new Thread(new ThreadStart(() =>
            {
                ...
                tcpServer = new Server(numConnections, receiveBufferSize, overtime);
